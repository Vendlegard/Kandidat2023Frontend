...
const CompetenceButtonComponent = ({compOrInterestName, addToCompetencies, index, isAdded }) => {
    ...
    function addCompetenceToProfile(interestToAdd) {
        ...
        addToCompetencies(interestToAdd);
    }
    ...
    return(
        <View className="">
            {isEven(index) ? (
                ...
                <TouchableOpacity  className="mr-4 " onPress={() => addCompetenceToProfile(compOrInterestName)}>
...
export default CompetenceButtonComponent